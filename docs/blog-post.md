...
👉 **[下載 StickyNotes.exe](https://github.com/tim12332000/StickyNotes/releases/download/v0.1.0/StickyNotes.exe)**(單一檔、免安裝),雙擊就能跑,不需要先裝 Python。

- 也可到 [Releases 頁面](https://github.com/tim12332000/StickyNotes/releases) 看所有版本,或自己打包(見方式二)。
...
- 標題列會有低調的狀態小圖示:🟠 有未同步變更 /(轉圈)同步中 / 🔴 同步失敗(移上去看原因)/ 已同步則不顯示。
